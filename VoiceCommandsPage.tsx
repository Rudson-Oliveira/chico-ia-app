        ...
        <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] font-sans antialiased">
            <div className="container mx-auto px-4 py-12">
                <header className="text-center mb-12 relative">
                    ...
                    <p className="text-lg text-[var(--text-secondary)] mt-4 max-w-3xl mx-auto">Entenda como interagir de forma eficiente com Chico. A chave é a naturalidade: ele está sempre pronto para ajudar quando o microfone ou a tela estão ativos.</p>
                </header>
                ...
                <main className="max-w-4xl mx-auto prose prose-lg prose-invert prose-p:text-[var(--text-secondary)] prose-headings:text-[var(--text-primary)] prose-strong:text-white prose-ul:text-[var(--text-secondary)] prose-li:marker:text-[var(--accent-primary)] prose-code:text-cyan-400 prose-code:before:content-none prose-code:after:content-none prose-blockquote:border-[var(--accent-primary)] prose-blockquote:text-gray-400">
                    ...
                    <p>Chico foi projetado para ser um copiloto que está sempre atento. Não são necessários comandos de ativação como "Ok, Chico" para chamar sua atenção.</p>
                    <div className="grid md:grid-cols-2 gap-6 my-8 not-prose">
                        <div className="bg-[var(--bg-secondary)] p-6 rounded-xl border border-[var(--border-color)]">
                            ...
                            <p className="text-base text-[var(--text-secondary)]">Quando o microfone está ativo, Chico está ouvindo. Apenas comece a falar. Ele processará sua fala após detectar uma breve pausa.</p>
                        </div>
                        <div className="bg-[var(--bg-secondary)] p-6 rounded-xl border border-[var(--border-color)]">
                           <div className="flex items-center space-x-3 mb-3">
                            ...
                            <p className="text-base text-[var(--text-secondary)]">Quando o compartilhamento de tela está ativo, Chico está analisando o conteúdo visual em tempo real para contextualizar suas respostas.</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-[var(--bg-secondary)] p-6 rounded-xl border border-[var(--border-color)] my-8 not-prose">
                        ...
                        <p className="text-base text-[var(--text-secondary)]">Para pedir que Chico aponte para algo específico, você precisa combinar uma palavra de <strong>captura</strong> com uma palavra de <strong>ação</strong> na mesma frase. Isso cria um destaque visual para guiá-lo.</p>
                        
                        <div className="grid md:grid-cols-2 gap-6 mt-6">
                            <div>
                                <h5 className="text-lg font-semibold text-white">Passo 1: A Captura (Peça para "ver")</h5>
                                <p className="text-base text-[var(--text-secondary)]">Diga ao Chico para analisar a tela atual. Use palavras como:</p>
                        ...
                        <div className="mt-8 border-t border-[var(--border-color)] pt-6">
                            ...
                            <p className="text-base text-[var(--text-secondary)]">Ao combinar os dois tipos de palavras, você ativa o destaque visual. Chico tira uma "foto" mental da sua tela e marca o elemento que você pediu:</p>
                    ...
                    <p>Você pode encerrar a sessão de voz a qualquer momento pedindo para Chico parar de ouvir. Isso desativará o microfone de forma segura.</p>
                    <ul>
                    ...
                    <p>Você pode encerrar a sessão de compartilhamento de tela a qualquer momento pedindo para Chico parar de compartilhar. Isso desativará o compartilhamento de forma segura.</p>
                    <ul>
                    ...
                    <p>Você pode iniciar o compartilhamento de tela a qualquer momento pedindo para Chico ativar o compartilhamento. Isso iniciará o processo de compartilhamento.</p>
                    <ul>
                    ...
                    <p>Chico pode te informar a data e hora exatas de Brasília. Basta perguntar de forma direta:</p>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li><strong>Pausa para Resposta:</strong> Chico é um bom ouvinte. Fale seu comando e faça uma pausa. Ele entenderá que é a vez dele de agir.</li>
                    </ul>
                </main>
