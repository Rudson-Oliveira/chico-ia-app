        ...
        <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] font-sans antialiased">
            <div className="container mx-auto px-4 py-12">
                ...
                <main className="max-w-4xl mx-auto prose prose-lg prose-invert prose-p:text-[var(--text-secondary)] prose-headings:text-[var(--text-primary)] prose-strong:text-white prose-ul:text-[var(--text-secondary)] prose-li:marker:text-[var(--accent-primary)] prose-code:text-cyan-400 prose-code:before:content-none prose-code:after:content-none prose-blockquote:border-[var(--accent-primary)] prose-blockquote:text-gray-400">
                    ...
                    <ul>
                        <li><strong>Assistência por Voz:</strong> Ative o microfone para conversar com Chico. Ele entende português, responde por voz e exibe um resumo em texto.</li>
                        <li><strong>Compartilhamento de Tela:</strong> Permite que Chico veja sua tela para fornecer ajuda contextualizada e precisa, guiando você em qualquer site ou aplicativo.</li>
                        <li><strong>Destaque Visual Inteligente:</strong> Ao pedir para Chico "marcar" ou "mostrar" algo, he exibirá um círculo vermelho pulsante sobre o elemento para te guiar com precisão.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li><strong>Chico não entende meus comandos:</strong> Tente falar mais perto do microfone e de forma mais clara. Consulte a seção "Comandos de Voz" para ver exemplos de palavras-chave.</li>
                    </ul>

                    <h3>Contato</h3>
                    <p>Se precisar de mais ajuda, entre em contato com nossa equipe de suporte pelo email: <strong>suporte@chico-ia.com</strong></p>
                </main>
